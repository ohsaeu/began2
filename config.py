...
flags.add_argument("--dataset", type=str, default= "16")
flags.add_argument("--data_dir", type=str, default="C:/samples/img_download/wheels/data2/img/20171205_128_gray_cluster/")
flags.add_argument("--log_dir", type=str, default="C:/samples/img_download/wheels/data2/output/began2_cluster_16_18-01-05/")
...
flags.add_argument('--skip_epoch', type=float, default=2)
